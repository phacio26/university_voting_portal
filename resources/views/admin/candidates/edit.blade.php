                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="mb-3">
                                                <img id="photo-preview" 
                                                     src="{{ $candidate->photo ? '/storage/' . $candidate->photo : 'https://via.placeholder.com/150' }}" 
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control @error('bio') is-invalid @enderror" 
                                                      ...
                                                      placeholder="Brief description about the candidate...">{{ old('bio', $candidate->bio) }}</textarea>
                                            @error('bio')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                ...
                                <div class="alert alert-info">
                                    ...
                                    @if($candidate->is_disqualified)
                                        ...
                                        @if($candidate->disqualification_reason)
                                            | <strong>Reason:</strong> {{ $candidate->disqualification_reason }}
                                        @endif
                                    @else
    ...
    <script>
        ...
        document.getElementById('photo').addEventListener('change', function(e) {
            ...
            if (file) {
                ...
                preview.src = '{{ $candidate->photo ? "/storage/" . $candidate->photo : "https://via.placeholder.com/150" }}';
            }
        });
