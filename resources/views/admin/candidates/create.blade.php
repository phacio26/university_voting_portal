            ...
            <div class="row g-4">
                <div class="col-md-4 text-center">
                    ...
                    <div class="mb-3">
                        <div class="photo-preview-wrap">
                            <div id="photo-placeholder" class="photo-placeholder">Candidate Photo</div>
                            <img id="photo-preview" src="" class="photo-preview" alt="Candidate photo preview">
                        </div>
                    </div>
                ...
                <div class="col-md-8">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('bio') is-invalid @enderror" id="bio" name="bio" rows="4" placeholder="Brief description about the candidate">{{ old('bio') }}</textarea>
                        @error('bio')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
